...
* Notes: Tested Task A,B,C with DocTest in test.cpp. Did not test task D and E as you cannot see if the memory was deallocated. Implemented all Tasks in main.cpp included the BONUS TASK (F).
